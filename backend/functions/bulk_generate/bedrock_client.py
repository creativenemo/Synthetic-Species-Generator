...
from models import nova_canvas, titan_v1, titan_v2, sdxl, stability_style_guide, stability_structure, stability_sketch
...
MODEL_BUILDERS = {
    ...
    "us.stability.stable-image-style-guide-v1:0": stability_style_guide.build_request,
    "us.stability.stable-image-control-structure-v1:0": stability_structure.build_request,
    "us.stability.stable-image-control-sketch-v1:0": stability_sketch.build_request,
}
...
def extract_images(model_id, response_body):
    ...
    elif model_id.startswith("us.stability."):
        return [base64.b64decode(img) for img in response_body["images"]]
    elif model_id.startswith("stability.stable-diffusion"):
        return [
