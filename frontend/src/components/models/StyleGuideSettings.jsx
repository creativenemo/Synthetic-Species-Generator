...
const MODEL_ID = 'us.stability.stable-image-style-guide-v1:0'
...
export default function StyleGuideSettings() {
  ...
  return (
    <div className="space-y-4">
      <SliderField label="Fidelity (reference adherence)" value={params.fidelity} min={0} max={1.0} step={0.05}
        onChange={(v) => update('fidelity', v)} />
